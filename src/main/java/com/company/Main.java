...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Constructor created for the department and json file -sc
        Department selector = new Department(null, null);
        Scanner scanner = new Scanner(System.in);
        //Constructor set for the data serialisation - sc
        JsonParser assetDetails = new JsonParser();
        //Constructor set for the user messages - sc
        Users welcome = new Users();
        //Constructor set for the username and password - sc
        Usage userAuthenticator = new Usage(null, null);

        //Welcome screen to present the user options - sc
        welcome.welcomeMessage();
        //loop to repeat the username entry until true - sc
        do {
        ...
        //Creating a loop to make sure only the available - sc
        // options are selected and correct file and department to be selected - sc
        do {
        ...
        //Creating a loop to make sure only the available
        // options are selected and correct User or System details and selected - sc
        do {
